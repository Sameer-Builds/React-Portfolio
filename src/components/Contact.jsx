    ...
    return (
        <>
            ...
            <div className='pb-10 container px-6 lg:pl-22 mx-auto  grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 space-x-5 space-y-5 text-center'>
                <div className="border border-red-500/20 rounded-3xl p-16 lg:w-72 group transition-all duration-500 hover:border-red-500/60">
                ...
                <div className="border border-red-500/20 rounded-3xl p-16 lg:w-72 text-center group transition-all duration-500 hover:border-red-500/60">
                ...
                <div className="border border-red-500/20 rounded-3xl p-16 lg:w-72 mb-5 text-center group transition-all duration-500 hover:border-red-500/60">
